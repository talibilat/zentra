...
describe("AgentTrail fleet API", () => {
  ...
  it("matches TypeScript allocation, unique-worker, backpressure, and stale-incarnation semantics", () => {
    ...
    const events = [
      ...
      stored(6, "scheduler.resources_acquired", { taskId: "task-a", resources: first.resources, acquiredAtMs: 6 }),
      stored(7, "scheduler.budget_acquired", { taskId: "task-a", budget: first.budget, acquiredAtMs: 7 }),
